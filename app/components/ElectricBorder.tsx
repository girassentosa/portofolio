  ...
  return (
    <div ref={rootRef} className={'relative isolate ' + (className ?? '')} style={style}>
      ...
      <div className="absolute inset-0 pointer-events-none" style={inheritRadius}>
        <div ref={strokeRef} className="absolute inset-0 box-border" style={strokeStyle as any} />
        <div className="absolute inset-0 box-border" style={glow1Style as any} />
        <div className="absolute inset-0 box-border" style={glow2Style as any} />
        <div className="absolute inset-0" style={bgGlowStyle as any} />
      </div>
